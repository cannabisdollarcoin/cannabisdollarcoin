...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("CannabisCoin-ext-ip");
...
static const char *strDNSSeed[][2] = {
    {"52.14.239.188", "52.14.239.188"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("CannabisCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("CannabisCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("CannabisCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("CannabisCoin-msghand");
...
void StartNode(void* parg)
{
    ...
    RenameThread("CannabisCoin-start");
...
int64_t PoissonNextSend(int64_t nNow, int average_interval_seconds) {
    return nNow + (int64_t)(double(float(GetRand(1ULL << 48) * -0.0000000000000035527136788 /* -1/2^48 */)) * average_interval_seconds * -1000000.0 + 0.5);
}
