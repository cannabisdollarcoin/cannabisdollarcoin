...
{
    resize(850, 550);
    setWindowTitle(tr("Cannabis Dollar Coin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Cannabis Dollar Coin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Cannabis Dollar Coin"), this);
    aboutAction->setStatusTip(tr("Show information about Cannabis Dollar Coin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cannabis Dollar Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cannabis Dollar Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cannabis Dollar Coin addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your Cannabis Dollar Coin addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Cannabis Dollar Coin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Cannabis Dollar Coin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cannabis Dollar Coin network", "", count));
}
...
{
    QString strTitle = tr("Cannabis Dollar Coin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Cannabis Dollar Coin address or malformed URI parameters."));
    }
