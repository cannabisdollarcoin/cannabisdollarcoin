...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("mCNC");
    case uBTC: return QString::fromUtf8("μCNC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("CannabisCoins"));
    case mBTC: return QString(QObject::tr("Milli-CannabisCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-CannabisCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
